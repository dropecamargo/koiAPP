...
class CreateDevolucion1Table extends Migration
{
    ...
    public function up()
    {
        Schema::create('devolucion1',function(Blueprint $table){
            ...
            $table->integer('devolucion1_asiento')->unsigned()->nullable();
            $table->integer('devolucion1_asienton')->unsigned()->nullable();
            ...
            $table->foreign('devolucion1_asiento')->references('id')->on('asiento1')->onDelete('restrict');
            $table->foreign('devolucion1_asienton')->references('id')->on('asienton1')->onDelete('restrict');
