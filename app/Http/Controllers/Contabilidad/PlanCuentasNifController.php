...
class PlanCuentasNifController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('contabilidad.plancuentasnif.index');
    }
    ...
    {
        return view('contabilidad.plancuentasnif.create');
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        if($plancuentanif instanceof PlanCuentaNif){
            ...
            return view('contabilidad.plancuentasnif.show', ['plancuentanif' => $plancuentanif]);
        }
        abort(404);
    }
    ...
    public function edit($id)
    {
        ...
        return view('contabilidad.plancuentasnif.edit', ['plancuentanif' => $plancuentanif]);
    }
