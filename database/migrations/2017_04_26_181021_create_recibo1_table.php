...
class CreateRecibo1Table extends Migration
{
    ...
    public function up()
    {
        Schema::create('recibo1', function(Blueprint $table){
            ...
            $table->integer('recibo1_asiento')->unsigned()->nullable();
            $table->integer('recibo1_asienton')->unsigned()->nullable();
            ...
            $table->foreign('recibo1_asiento')->references('id')->on('asiento1')->onDelete('restrict');
            $table->foreign('recibo1_asienton')->references('id')->on('asienton1')->onDelete('restrict');
