...
class CreateSaldostercerosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('saldosterceros', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            ...
            $table->foreign('saldosterceros_cuenta')->references('id')->on('plancuentas')->onDelete('restrict');
            $table->foreign('saldosterceros_tercero')->references('id')->on('tercero')->onDelete('restrict');
            $table->unique(['saldosterceros_cuenta', 'saldosterceros_ano', 'saldosterceros_mes', 'saldosterceros_tercero'], 'saldosterceros_cuenta_ano_mes_tercero_unique');
        });
    }
    ...
    {
        Schema::dropIfExists('saldosterceros');
    }
}
