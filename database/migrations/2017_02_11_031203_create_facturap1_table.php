...
class CreateFacturap1Table extends Migration
{
    ...
    public function up()
    {
        Schema::create('facturap1', function (Blueprint $table) {
            ...
            $table->foreign('facturap1_sucursal')->references('id')->on('sucursal')->onDelete('restrict');
            $table->foreign('facturap1_tercero')->references('id')->on('tercero')->onDelete('restrict');
            $table->foreign('facturap1_usuario_elaboro')->references('id')->on('tercero')->onDelete('restrict');
        });
    }
