    ...
    <script type="text/template" id="add-retefuente-tpl">
        <div class="row">
            ...
            <div class="form-group col-md-2">
                <label for="retefuente_tarifa_juridico" class="control-label">Porcentaje tarifa juridico %</label>
        ...
        <div class="row">
            <div class="form-group col-sm-6 col-md-2">
                ...
                <div class="input-group input-group-sm">
                    ...
                    <input id="retefuente_plancuentas" placeholder="Cuenta" class="form-control plancuenta-koi-component" name="retefuente_plancuentas" type="text" maxlength="15" data-wrapper="asientos-create" data-name="cuenta_nombre" value="<%- plancuentas_cuenta %>">
                </div>
            </div>
