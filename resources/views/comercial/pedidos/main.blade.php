...
@section('content')
    <section class="content-header">
        <h1>
            Pedidos comerciales <small>Administración de pedidos comerciales</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <script type="text/template" id="add-pedidosc-tpl" >
        <div class="box-body">
            <form method="POST" accept-charset="UTF-8" id="form-pedidoc1" data-toggle="validator">
                ...
                <div class="row">
                    <label for="pedidoc1_tercero" class="col-md-1 col-md-1 control-label">Cliente</label>
                    <div class="form-group col-md-2">
                ...
                <div class="row">
                    <label for="tcontacto_nombre" class="col-md-1 col-md-1 control-label">Contacto</label>
                    <div class="form-group col-md-4">
                        <div class="input-group input-group-sm">
                            <span class="input-group-btn">
        ...
        <div class="box-body box box-primary">
            <form method="POST" accept-charset="UTF-8" id="form-detalle-pedidoc" data-toggle="validator">
                <div class="row">
                    ...
                    <label for="pedidoc2_cantidad" class="col-xs-6 col-md-1 col-md-1 control-label">Cantidad </label>
                    ...
                    <label for="pedidoc2_costo" class="col-xs-6 col-md-1 col-md-1 control-label">Precio </label>
