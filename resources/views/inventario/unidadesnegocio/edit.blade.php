...
@section('module')
	<div class="box box-success" id="unidadesnegocio-create">
		{!! Form::open(['id' => 'form-unidadesnegocio', 'data-toggle' => 'validator']) !!}
	        ...
	        <div class="box-footer with-border">
	        	<div class="row">
					<div class="col-md-2 col-md-offset-4 col-sm-6 col-xs-6 text-left">
						<a href="{{ route('unidadesnegocio.show', ['unidadnegocio' => $unidadnegocio->id]) }}" class="btn btn-default btn-sm btn-block">{{ trans('app.cancel') }}</a>
					</div>
