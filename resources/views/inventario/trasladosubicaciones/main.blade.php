...
@section('content')
    ...
    <script type="text/template" id="add-trasladoubicacion-tpl">
        ...
        <form method="POST" accept-charset="UTF-8" id="form-item-trasladoubicacion" data-toggle="validator">
            <div class="box-body">
                <div class="row">
                    <div class="form-group col-md-2 col-sm-4 col-xs-12 col-md-offset-1">
                    ...
                    <label for="trasladou2_cantidad" class="col-md-1 col-sm-2 col-xs-2 control-label">Unidades</label>
        ...
        <div class="table-responsive no-padding">
            <table id="browse-detalle-trasladou-list" class="table table-bordered" cellspacing="0" width="100%">
                <tr>
                    <th></th>
                    <th>Código</th>
                    <th>Producto</th>
