...
class CreatePlancuentasnTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('plancuentasn', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            ...
            $table->double('plancuentasn_tasa')->default(0)->nullable();
            ...
            $table->foreign('plancuentasn_centro')->references('id')->on('centrocosto')->onDelete('restrict');
        });
    }
    ...
    {
        Schema::dropIfExists('plancuentasn');
    }
}
