    ...
    public function movimientos(Request $request)
    {
        if ($request->ajax()) {
            ...
            if($request->has('asiento2')) {
                ...
                $query->select('asientomovimiento.*', 'producto_codigo', 'producto_nombre', 'producto.id as producto_id', 'sucursal_nombre');
