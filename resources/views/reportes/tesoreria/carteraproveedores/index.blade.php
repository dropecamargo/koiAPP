...
@section('title') Reporte cartera proveedores @stop

@section('content')
    <section class="content-header">
		<h1>
			Reporte cartera proveedores
		</h1>
		<ol class="breadcrumb">
			<li><a href="{{ route('dashboard') }}"><i class="fa fa-dashboard"></i> {{ trans('app.home') }}</a></li>
			<li class="active">Reporte cartera proveedores</li>
		</ol>
    </section>
	    ...
	    <div class="box box-success">
	    	<form action="{{ route('rcarteraedadesproveedores.index') }}" method="GET" data-toggle="validator">
				...
				<div class="box-body">
					...
					<div class="row">
						<label for="filter_regional" class="col-sm-1 control-label">Regional</label>
