	    ...
	    <div class="box box-success">
	    	<form action="{{ route('rcarteraedades.index') }}" method="GET" data-toggle="validator">
				...
				<div class="box-body">
					<div class="row">
					    ...
					    <div class="form-group col-md-2">
					        <div class="input-group input-group-sm">
					            ...
					            <input id="filter_tercero" placeholder="Cliente" class="form-control tercero-koi-component" name="filter_tercero" type="text" maxlength="15" data-name="filter_terecero_nombre">
					        </div>
					    </div>
					    <div class="col-md-4 col-xs-12">
					        <input id="filter_terecero_nombre" name="filter_terecero_nombre" placeholder="Nombre cliente" class="form-control input-sm" type="text" maxlength="15" readonly >
					    </div>
					</div>		
					<div class="row">
					...
					<div class="row">
						<label for="filter_sucursal" class="col-sm-1 control-label">Regionales</label>
