...
@section('breadcrumb')
    <li><a href="{{ route('categorias.index')}}">Editar</a></li>
    <li><a href="{{ route('categorias.show', ['categoria' => $categoria->id]) }}">{{ $categoria->id }}</a></li>
	<li class="active">Editar</li>
@stop

@section('module')
	<div class="box box-success" id="categoria-create">
