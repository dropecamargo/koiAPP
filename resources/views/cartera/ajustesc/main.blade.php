                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        <div class="input-group input-group-sm">
                            ...
                            <input id="ajustec1_tercero" placeholder="Cliente" class="form-control tercero-koi-component" name="ajustec1_tercero" type="text" maxlength="15" data-cliente="true" data-wrapper="ajustec-create" data-name="tercero_nombre" value="<%- tercero_nit %>" required>
                        </div>
                    </div>
