...
@section('module')
    <section class="content-header">
        <h1>
            Cajas menores <small>Administración cajas menores</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('dashboard') }}"><i class="fa fa-dashboard"></i> {{ trans('app.home') }}</a></li>
            <li class="active">Cajas menores</li>
        </ol>
    </section>
                ...
                <div class="box-body">
                    {!! Form::open(['id' => 'form-koi-search-ajuste-component', 'class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form']) !!}
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select id="searchcajamenor_regional"  class="form-control select2-default" name="searchcajamenor_regional">
