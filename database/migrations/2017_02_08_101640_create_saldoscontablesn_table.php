...
class CreateSaldoscontablesnTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('saldoscontablesn', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            ...
            $table->foreign('saldoscontablesn_cuenta')->references('id')->on('plancuentasn')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('saldoscontablesn');
    }
}
