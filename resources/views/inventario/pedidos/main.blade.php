    ...
    <script type="text/template" id="add-pedido-tpl">
        <div class="box-body" id="render-form-pedido">
            <form method="POST" accept-charset="UTF-8" id="form-pedido" data-toggle="validator">
                ...
                <div class="row">
                    <label for="pedido1_fecha" class="col-sm-2 control-label">Fecha</label>
                    <div class="form-group col-sm-2 ">
                ...
                <div class="row">
                    <label for="pedido1_fecha_anticipo" class="col-sm-2 control-label">Fecha Anticipo</label>
                    <div class="form-group col-sm-2">
            ...
            <div class="row">
             ...
             <div id="detalle-pedido" class="row">
                <form method="POST" accept-charset="UTF-8" id="form-detalle-pedido" data-toggle="validator">
                    <div class="row">
                            ...
                            <div class="form-group col-sm-1">
                                <button type="submit" class="btn btn-seccess btn-sm btn-block">
