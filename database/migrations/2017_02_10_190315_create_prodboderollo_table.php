...
class CreateProdboderolloTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('prodboderollo', function (Blueprint $table) {
            ...
            $table->foreign('prodboderollo_producto')->references('id')->on('producto')->onDelete('restrict');
            $table->foreign('prodboderollo_sucursal')->references('id')->on('sucursal')->onDelete('restrict');
            $table->unique(['prodboderollo_producto', 'prodboderollo_sucursal', 'prodboderollo_item'], 'prodboderollo_producto_sucursal_item_unique');
        });
    }
