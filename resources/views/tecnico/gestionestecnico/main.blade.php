...
@section('content')
    ...
    <script type="text/template" id="add-gestiontecnico-tpl">
        <div class="row">
            <label for="gestiontecnico_tercero" class="col-sm-1 control-label">Cliente</label>
        ...
        <div class="row">
            <label for="gestiontecnico_conceptotec" class="control-label col-sm-1">Concepto</label>
            <div class="form-group col-sm-3">
            ...
            <label for="gestiontecnico_tecnico" class="col-sm-1 control-label">Tecnico</label>
        ...
        <div class="row">
            ...
            <label for="gestiontecnico_hinicio" class="col-sm-1 control-label">Hora inicio</label>
            <div class="form-group col-sm-2">
            ...
            <label for="gestiontecnico_hfinalizo" class="col-sm-1 control-label">Hora finalización</label>
            <div class="form-group col-sm-2">
                <div class="bootstrap-timepicker">
                    <div class="input-group">
